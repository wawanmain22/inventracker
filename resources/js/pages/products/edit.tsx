            ...
            <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="min-w-0">
                        <h1 className="truncate text-xl font-bold sm:text-2xl lg:text-3xl">Edit Produk</h1>
                        <p className="truncate text-xs text-muted-foreground sm:text-sm">Ubah informasi produk</p>
                    </div>
                </div>
